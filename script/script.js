...
function myFunc(value){
    ...
    if(field[value]=='banana'){
        let timerId = setTimeout(function() {
            document.getElementById("result").style.backgroundImage = "url('style/image/fail.png')";
            console.log(value, 'FAIL')
        }, 1000);
    }else{
        let timerId = setTimeout(function() {
            document.getElementById("result").style.backgroundImage = "url('style/image/win.png')";
...
function playFunc(){
    ...
    while(count < 3){
        ...
        if(!(rand in field)){
            ...
            var ur = "url('style/image/" + field[rand] + ".png')"
            var st = 'd'+rand
    ...
    let timerId = setTimeout(function() {
        document.getElementById("game_field").style.backgroundImage = "url('style/image/cat.png')";
